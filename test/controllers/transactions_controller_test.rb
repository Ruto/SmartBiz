...
class TransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction" do
    assert_difference('Transaction.count') do
      post transactions_url, params: { transaction: { account_id: @transaction.account_id, balance: @transaction.balance, closed: @transaction.closed, image_id: @transaction.image_id, memo: @transaction.memo, money_in: @transaction.money_in, money_out: @transaction.money_out, structure_id: @transaction.structure_id, total_balance: @transaction.total_balance, transaction_cost: @transaction.transaction_cost, transactionable_id: @transaction.transactionable_id, transactionable_type: @transaction.transactionable_type, type: @transaction.type, user_id: @transaction.user_id } }, as: :json
    end
