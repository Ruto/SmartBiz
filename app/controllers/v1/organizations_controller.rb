  ...
  class OrganizationsController < ApplicationController
    ...
    def create
      ...
      if @organization.save
          ...
          Structure.create(:name => "#{@organization.name} AdminstrativeCost", :parent => get_adminstrative_cost_parent, :type => "Structures::AdminstrativeCost", :structurable_id => @organization.id, :structurable_type => "Organization", :category => "AdminstrativeCost", :structure_id => @structure.id, :user_id => @organization.user_id, :active => @organization.adminstrative_cost)
    ...
    private
      ...
      def organization_params
        params.permit(:name, :alias, :type, :category, :income, :direct_expense, :indirect_expense, :adminstrative_cost, :active, :user_id, :parent_id)
      end
